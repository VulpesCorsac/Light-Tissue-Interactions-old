...
template < typename T >
template < typename U >
bool Vector3D<T>::operator == (const Vector3D<U>& another) const noexcept {
...
template < typename T >
Vector3D<T>::operator bool() const noexcept {
    return x != 0 || y != 0 || z != 0;
}
...
template < typename T >
const T& Vector3D<T>::operator [] (int idx) const {
    if (idx == 0)
        return x;
    if (idx == 1)
        return y;
...
template < typename T >
Vector3D<T> Vector3D<T>::operator + () const noexcept {
    return *this;
}
...
template < typename T >
template < typename U >
Vector3D<T>& Vector3D<T>::operator += (const Vector3D<U>& another) noexcept {
    x += another.x;
    y += another.y;
    z += another.z;
    return *this;
...
template < typename T >
template < typename U >
Vector3D<T>& Vector3D<T>::operator *= (const U& scale) noexcept {
    x *= scale;
    y *= scale;
    z *= scale;
    return *this;
...
template < typename T >
template < typename U >
Vector3D<T>& Vector3D<T>::operator /= (const U& scale) {
    if (!scale)
...
template < typename T >
T Vector3D<T>::norm2() const noexcept {
    return (*this) * (*this);
}

template < typename T >
T Vector3D<T>::norm() const noexcept {
