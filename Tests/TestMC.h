...
void TestsMC::SingleLayerAbsorptionOnly() {
    ...
    std::cout << "Single layer, absorption only" << std::endl;
    ...
    Medium<T> tissue1(1.5, 1000, 0, 1e-3, 0.9); //MFP == D
    Medium<T> tissue2(1.3, 100, 0, 1e-3, 0.5); //MFP = 10 D
    Medium<T> tissue3(1.6, 1000, 0, 10e-3, 0.0); //MFP == 0.1D, it will need more photons
    ...
    assert(std::abs(res1.diffuseReflection - 0.004989) < 1e-3);
    assert(std::abs(res1.diffuseTransmission - 0.3390) < 1e-3);
    assert(std::abs(res1.diffuseTransmission - BugerLambert(1.0, 1.5, 1.0, 1.0)) < 1e-3);
    ...
    assert(std::abs(MTres1.diffuseReflection - 0.004989) < 1e-3);
    assert(std::abs(MTres1.diffuseTransmission - 0.3390) < 1e-3);
    assert(std::abs(MTres1.diffuseTransmission - BugerLambert(1.0, 1.5, 1.0, 1.0)) < 1e-3);
    ...
    assert(std::abs(res2.specularReflection - 0.0170132) < 1e-4);
    assert(std::abs(res2.diffuseReflection - 0.01346) < 1e-3);
    assert(std::abs(res2.diffuseTransmission - 0.8743) < 1e-3);
    assert(std::abs(res2.diffuseTransmission - BugerLambert(0.1, 1.3, 1.0, 1.0)) < 1e-3);
    ...
    assert(std::abs(MTres2.specularReflection - 0.0170132) < 1e-4);
    assert(std::abs(MTres2.diffuseReflection - 0.01346) < 1e-3);
    assert(std::abs(MTres2.diffuseTransmission - 0.8743) < 1e-3);
    assert(std::abs(MTres2.diffuseTransmission - BugerLambert(0.1, 1.3, 1.0, 1.0)) < 1e-3);
    ...
    assert(std::abs(res3.diffuseReflection - 0.0) < 1e-3);
    assert(std::abs(res3.diffuseTransmission - 0.00004069) < 5e-6);
    assert(std::abs(res3.diffuseTransmission - BugerLambert(10.0, 1.6, 1.0, 1.0)) < 5e-6);
    ...
    assert(std::abs(MTres3.diffuseTransmission - 0.00004069) < 2e-6);
    assert(std::abs(MTres3.diffuseTransmission - BugerLambert(10.0, 1.6, 1.0, 1.0)) < 2e-6);
...
void TestsMC::MultiLayerAbsorptionOnly() {
    ...
    std::cout << "Glass-tissue-glass, absorption only" << std::endl;
    ...
    std::vector<Medium<T>> layer1 = {glass1, tissue1, glass1};
    ...
    assert(std::abs(res1.diffuseReflection - 0.00656) < 1e-3);
    assert(std::abs(res1.diffuseTransmission - 0.3292) < 1e-3);
    assert(std::abs(res1.diffuseTransmission - BugerLambert(1.0, 1.5, 1.6, 1.6)) < 1e-3);
    assert(std::abs(res1.diffuseTransmission + res1.diffuseReflection +
                    res1.specularReflection + res1.absorbed - 1.0) < 1e-4);
    ...
    assert(std::abs(MTres1.diffuseReflection - 0.00656) < 1e-3);
    assert(std::abs(MTres1.diffuseTransmission - 0.3292) < 1e-3);
    assert(std::abs(MTres1.diffuseTransmission - BugerLambert(1.0, 1.5, 1.6, 1.6)) < 1e-3);
    assert(std::abs(MTres1.diffuseTransmission + MTres1.diffuseReflection +
                    MTres1.specularReflection + MTres1.absorbed - 1.0) < 1e-4);
    ...
    assert(std::abs(res2.diffuseReflection - 0.02244) < 1e-3);
    assert(std::abs(res2.diffuseTransmission - 0.853) < 1e-3);
    assert(std::abs(res2.diffuseTransmission - BugerLambert(0.1, 1.3, 1.4, 1.4)) < 1e-3);
    assert(std::abs(res2.diffuseTransmission + res2.diffuseReflection +
                    res2.specularReflection + res2.absorbed - 1.0) < 1e-4);
    ...
    assert(std::abs(MTres2.diffuseReflection - 0.02244) < 1e-3);
    assert(std::abs(MTres2.diffuseTransmission - 0.853) < 1e-3);
    assert(std::abs(MTres2.diffuseTransmission - BugerLambert(0.1, 1.3, 1.4, 1.4)) < 1e-3);
    assert(std::abs(MTres2.diffuseTransmission + MTres2.diffuseReflection +
                    MTres2.specularReflection + MTres2.absorbed - 1.0) < 1e-4);
    ...
    assert(std::abs(res3.diffuseReflection - 0.0) < 1e-3);
    assert(std::abs(res3.diffuseTransmission - 0.00004008) < 5e-6);
    assert(std::abs(res3.diffuseTransmission - BugerLambert(10.0, 1.6, 1.65, 1.65)) < 5e-6);
    assert(std::abs(res3.diffuseTransmission + res3.diffuseReflection +
                    res3.specularReflection + res3.absorbed - 1.0) < 1e-4);
    ...
    assert(std::abs(MTres3.diffuseReflection - 0.0) < 1e-3);
    assert(std::abs(MTres3.diffuseTransmission - 0.00004008) < 2e-6);
...
void TestsMC::SingleLayerAbsorptionScattering() {
    ...
    assert(std::abs(res3.diffuseTransmission - 0.0000549) < 1e-5);
    assert(std::abs(res3.diffuseTransmission + res3.diffuseReflection +
                    res3.specularReflection + res3.absorbed - 1.0) < 1e-4);
