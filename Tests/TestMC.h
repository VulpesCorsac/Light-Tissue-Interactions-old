...
public:
    ...
    const auto tissue2 = Medium<T>::fromCoeffs{1.3,  100, 0, 1e-3, 0.5}; // MFP == D * 10
    const auto tissue3 = Medium<T>::fromCoeffs{1.6, 1000, 0, 1e-2, 0.0}; // MFP == D * 0.1
};
...
public:
    const auto glass = Medium<T>::fromCoeffs{1.6 , 0, 0, 1e-3, 0};
...
public:
    const auto glass = Medium<T>::fromCoeffs{1.4 , 0, 0, 1e-3, 0};
...
public:
    const auto glass = Medium<T>::fromCoeffs{1.65, 0, 0, 1e-3, 0};
...
public:
    ...
    const auto tissue2 = Medium<T>::fromCoeffs{1.3,  20,  80,  1e-3, 0.5}; // MFP == D * 10
    const auto tissue3 = Medium<T>::fromCoeffs{1.6, 700, 300, 10e-3, 0.0}; // MFP == D * 0.1
};
...
public:
    const auto glass1 = Medium<T>::fromCoeffs{1.6 , 0, 0, 1e-3, 0};
    const auto glass3 = Medium<T>::fromCoeffs{1.65, 0, 0, 1e-3, 0};
