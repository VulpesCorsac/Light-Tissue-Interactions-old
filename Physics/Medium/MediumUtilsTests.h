...
TEST(MediumUtilsTests, MediumFromProperties_ForMediumGlass) {
    constexpr float n0 = 2;
    constexpr float r0 = 3;
    constexpr float c0 = 4;
    constexpr float k0 = 5;
    auto medium = std::make_unique<MediumGlass<float>>(n0, r0, c0, k0);
    const auto& properties = exportMediumProperties(medium.get());
    const auto generatedMedium = mediumFromProperties(properties);
    const auto generated = exportMediumProperties(generatedMedium.get());
    EXPECT_EQ(generated.type, MediumType::Glass);
    EXPECT_FLOAT_EQ(generated.n0.value(), n0);
    EXPECT_FLOAT_EQ(generated.r0.value(), r0);
    EXPECT_FLOAT_EQ(generated.c0.value(), c0);
    EXPECT_FLOAT_EQ(generated.k0.value(), k0);
}
TEST(MediumUtilsTests, MediumFromProperties_ForMediumConstant) {
    constexpr float n0 = 2;
    constexpr float a0 = 3;
    constexpr float u0 = 4;
    constexpr float g0 = 5;
    ...
    const auto generatedMedium = mediumFromProperties(properties);
    const auto generated = exportMediumProperties(generatedMedium.get());
    EXPECT_EQ(generated.type, MediumType::Constant);
    EXPECT_FLOAT_EQ(generated.n0.value(), n0);
    EXPECT_FLOAT_EQ(generated.a0.value(), a0);
    EXPECT_FLOAT_EQ(generated.u0.value(), u0);
    EXPECT_FLOAT_EQ(generated.g0.value(), g0);
    EXPECT_FLOAT_EQ(generated.r0.value(), r0);
    EXPECT_FLOAT_EQ(generated.c0.value(), c0);
    EXPECT_FLOAT_EQ(generated.k0.value(), k0);
}

TEST(MediumUtilsTests, MediumFromProperties_ForMediumLinear) {
    constexpr float n0 = 2;
    constexpr float nT = 3;
    constexpr float nD = 4;
    constexpr float a0 = 5;
    ...
    const auto generatedMedium = mediumFromProperties(properties);
    const auto generated = exportMediumProperties(generatedMedium.get());
    EXPECT_EQ(generated.type, MediumType::Linear);
    EXPECT_FLOAT_EQ(generated.n0.value(), n0);
    EXPECT_FLOAT_EQ(generated.nT.value(), nT);
    EXPECT_FLOAT_EQ(generated.nD.value(), nD);
    EXPECT_FLOAT_EQ(generated.a0.value(), a0);
    EXPECT_FLOAT_EQ(generated.aT.value(), aT);
    EXPECT_FLOAT_EQ(generated.aD.value(), aD);
    EXPECT_FLOAT_EQ(generated.u0.value(), u0);
    EXPECT_FLOAT_EQ(generated.uT.value(), uT);
    EXPECT_FLOAT_EQ(generated.uD.value(), uD);
    EXPECT_FLOAT_EQ(generated.g0.value(), g0);
    EXPECT_FLOAT_EQ(generated.gT.value(), gT);
    EXPECT_FLOAT_EQ(generated.gD.value(), gD);
    EXPECT_FLOAT_EQ(generated.r0.value(), r0);
    EXPECT_FLOAT_EQ(generated.rT.value(), rT);
    EXPECT_FLOAT_EQ(generated.rD.value(), rD);
    EXPECT_FLOAT_EQ(generated.c0.value(), c0);
    EXPECT_FLOAT_EQ(generated.cT.value(), cT);
    EXPECT_FLOAT_EQ(generated.cD.value(), cD);
    EXPECT_FLOAT_EQ(generated.k0.value(), k0);
    EXPECT_FLOAT_EQ(generated.kT.value(), kT);
    EXPECT_FLOAT_EQ(generated.kD.value(), kD);
}

TEST(MediumUtilsTests, MediumFromProperties_ForMediumArbitrary) {
    constexpr float n0  = 2;
    constexpr float nT  = 3;
    constexpr float nD  = 4;
    constexpr float nDT = 5;
    ...
    const auto generatedMedium = mediumFromProperties(properties);
    const auto generated = exportMediumProperties(generatedMedium.get());
    EXPECT_EQ(generated.type, MediumType::Arbitrary);
    EXPECT_FLOAT_EQ(generated.n0.value() , n0 );
    EXPECT_FLOAT_EQ(generated.nT.value() , nT );
    EXPECT_FLOAT_EQ(generated.nD.value() , nD );
    EXPECT_FLOAT_EQ(generated.nDT.value(), nDT);
    EXPECT_FLOAT_EQ(generated.a0.value() , a0 );
    EXPECT_FLOAT_EQ(generated.aT.value() , aT );
    EXPECT_FLOAT_EQ(generated.aD.value() , aD );
    EXPECT_FLOAT_EQ(generated.aDT.value(), aDT);
    EXPECT_FLOAT_EQ(generated.u0.value() , u0 );
    EXPECT_FLOAT_EQ(generated.uT.value() , uT );
    EXPECT_FLOAT_EQ(generated.uD.value() , uD );
    EXPECT_FLOAT_EQ(generated.uDT.value(), uDT);
    EXPECT_FLOAT_EQ(generated.g0.value() , g0 );
    EXPECT_FLOAT_EQ(generated.gT.value() , gT );
    EXPECT_FLOAT_EQ(generated.gD.value() , gD );
    EXPECT_FLOAT_EQ(generated.gDT.value(), gDT);
    EXPECT_FLOAT_EQ(generated.r0.value() , r0 );
    EXPECT_FLOAT_EQ(generated.rT.value() , rT );
    EXPECT_FLOAT_EQ(generated.rD.value() , rD );
    EXPECT_FLOAT_EQ(generated.rDT.value(), rDT);
    EXPECT_FLOAT_EQ(generated.c0.value() , c0 );
    EXPECT_FLOAT_EQ(generated.cT.value() , cT );
    EXPECT_FLOAT_EQ(generated.cD.value() , cD );
    EXPECT_FLOAT_EQ(generated.cDT.value(), cDT);
    EXPECT_FLOAT_EQ(generated.k0.value() , k0 );
    EXPECT_FLOAT_EQ(generated.kT.value() , kT );
    EXPECT_FLOAT_EQ(generated.kD.value() , kD );
    EXPECT_FLOAT_EQ(generated.kDT.value(), kDT);
}
